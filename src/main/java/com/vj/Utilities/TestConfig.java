...
public class TestConfig{
	...
	public static String from = "vj.sableforever05@gmail.com";
	public static String password = "9823232959";
	public static String[] to ={"vijay.sable125@gmail.com","vj.sableforever05@gmail.com"};
